...
#one line version 
regenie --step 1 --bed ukb_cal_allChrs --bed qc_pass_ld --phenoFile bc.txt --remove fid_to_remove_breast.txt --covarFile covariates_breast.txt --bt --bsize 1000 --lowmem --lowmem-prefix tmpdir/regenie_tmp_preds --out ukb_step1_BT
```
